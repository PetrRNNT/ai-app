declare global {
  ...
  const getUserIdFromEvent: typeof import('../../server/utils/auth').getUserIdFromEvent
...
export { buildAssetsURL as __buildAssetsURL, publicAssetsURL as __publicAssetsURL } from 'C:/Users/ipetr/Documents/todo-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/paths';
export { defineAppConfig } from 'C:/Users/ipetr/Documents/todo-app/node_modules/@nuxt/nitro-server/dist/runtime/utils/config';
export { hashPassword, verifyPassword, signToken, verifyToken, getUserIdFromToken, getUserIdFromEvent } from 'C:/Users/ipetr/Documents/todo-app/server/utils/auth';
export { default as db } from 'C:/Users/ipetr/Documents/todo-app/server/utils/db';